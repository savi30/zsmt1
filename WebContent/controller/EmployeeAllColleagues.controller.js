		...
		.define(
				...
				function(JQuery, BaseController, MessageToast, History) {
					...
					return BaseController
							.extend(
									"zsmt1.controller.EmployeeAllColleagues",
									{
										...
										onInit : function() {
											...
											oView = this.getView();
											oRouter
													.getRoute("employeeAllColleagues")
													.attachMatched(
											...
											oDisplayFragment = sap.ui
													.xmlfragment(this.getView()
															.getId(),
															"zsmt1.view.EmployeeAllColleaguesDetail");
											oLayout = this
													.getView()
													.byId(
															"employeeAllColleaguesDetailsFragment");
											oLayout
										...
										handleOpenToolbar : function(oEvent) {
											...
											if (!this._actionSheet) {
												this._actionSheet = sap.ui
														.xmlfragment(
																"zsmt1.view.EmployeeAllColleaguesToolbar",
																this);
