sap.ui.define([ "jquery.sap.global", "zsmt1/controller/BaseController",
	...
	return BaseController.extend("zsmt1.controller.EmployeeAllColleaguesProjects", {

		onInit : function() {
			oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("employeeAllColleagues").attachMatched(this._onRouteMatched,
					this);
		...
		_onRouteMatched :function(oEvent) {
			...
			var oList = this.getView().byId("employeeAllColleaguesProjectList");
			oList.bindItems({
